export default function Hero() {
  // ✅ Renomeado para scrollToSection — evita conflito com window.scrollTo
  const scrollToSection = (id) =>
    document.getElementById(id)?.scrollIntoView({ behavior: "smooth" });

  return (
    <section id="home" className="min-h-screen flex flex-col justify-center px-6 md:px-[6%] relative overflow-hidden pt-20">
      ...
      <p className="text-muted mt-6 max-w-2xl leading-relaxed text-lg">
        Desenvolvedor Fullstack com experiência prática em projetos pessoais utilizando PHP, Laravel,
        Livewire, MySQL, JavaScript, HTML e CSS, transformando ideias em produtos digitais de alta qualidade.
      </p>
